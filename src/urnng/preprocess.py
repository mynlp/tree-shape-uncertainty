...
def get_data(args):
    ...
    def convert(
        ...
        for tree in open(textfile, "r"):
            ...
            # Added
            # This script cannot deal with the case "(FRAG hoge)" that appears in KTB.
            # So, simply skip such examples.
            try:
            ...
            other_data.append(
                [sent_str, tags, action, binary_actions, nonbinary_actions, span, tree]
            )
    ...
    print("sequence length: ", train_seqlength, valid_seqlength, test_seqlength)
    max_sent_l = 0
    max_sent_l = convert(
        args.testfile,
        args.lowercase,
...
def main(arguments):
    ...
    parser.add_argument(
        "--replace_num", help="Replace numbers with N", type=int, default=0
    )
    ...
    parser.add_argument(
        "--batchsize", help="Size of each minibatch.", type=int, default=16
    )
    parser.add_argument(
        "--seqlength",
